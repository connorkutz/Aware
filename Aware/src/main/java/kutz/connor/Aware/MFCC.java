...
public class MFCC {
	...
	public float[] process(double[] doubleInputBuffer, int numFFt) {
		final double[][] mfccResult = dctMfcc(doubleInputBuffer, numFFt);
...
//DCT to mfcc, librosa
	private double[][] dctMfcc(double[] y, int numFFT){
